...
public class TextureRect4
{
    ...
    float tEnd;
    float span;
    public TextureRect4(MySurfaceView mv,
                        float width,float height,	//矩形的宽高
                        float sEnd, float tEnd,float span //右下角的s、t值
    )
    {
    ...
    public void initVertexData()
    {
        ...
        float texCoor[]=new float[]//纹理坐标
                {
                        0.1f-span,0.1f-span, 0.1f-span,0.9f+span, 0.9f+span,0.1f-span,
                        0.1f-span,0.9f+span, 0.9f+span,0.9f+span, 0.9f+span,0.1f-span
                };
        //创建顶点纹理坐标数据缓冲
    ...
    public void drawSelf(int texId1,float t)
    {
        //制定使用某套着色器程序
